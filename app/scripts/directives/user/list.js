    ...
    mod
        ...
        .directive('userCaptcha', function($rootScope, $templateCache, $filter, $compile, widget, $uibModal) {
            return {
                ...
                template: '<a class="btn btn-success btn-rounded btn-sm pull-right" ng-click="show();">获取验证码</a>',
                link: function($scope, $element, $attrs) {
                    var supscope = $scope;
                    $scope.show = function() {
                        var modalInstance = $uibModal.open({
                            ...
                            controller: function($scope, $uibModalInstance) {
                                $scope.tmpl = '<div class="form-horizontal" name="FormBody" novalidate>' +
                                    '<div form-input text="手机号码" ng-model="mobile" required="true"> </div> ' +
                                    '<div form-input text="验证码" ng-model="captcha" ng-disabled="true"> </div> ' +
                                    '<a class="btn btn-success btn-rounded btn-sm pull-right" ng-click="getCaptcha();">获取验证码</a>' +
                                    '</form>';
                                $scope.title = '获取验证码';
                                $scope.mobile = angular.copy(supscope.data.mobile) || '';
