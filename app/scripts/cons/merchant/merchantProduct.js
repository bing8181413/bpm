  ...
  var rtn = {
    merchantProductList: {
      ...
      columns_by_merchant: [
        ...
        {
          name:'课程链接',
          fieldDirective:'<div modal-textarea title="查看{{item.product_id}}" content="$root.common.wx_domain+\'/product/detail/product_id/\'+item.product_id+\'?utm_source=\'+item.merchant_product.utm_source+\'&utm_medium=&utm_campaign=\'"></div>'
        },
        // {
        //   name: '链接',
