  ...
  var rtn = {
    merchantStaticsList: {
      columns: [
        ...
        {
          name: '结算',
          fieldDirective: '<span show-table data="{text:\'结算\',modid:\'merchantOrderList\',config:\'config\',columns:\'columns\',ext:{merchant_id:item.id},extApi:$root.common.domain+\'/merchant/merchantorders/\'}"></span>',
        },
      ],
      config: {
        title: '供应商管理',
