        ...
        marketsharesList: {
            columns: [
                ...
                // },
                {
                    ...
                    '<span show-table ng-show="item.receive_type==4" data="{text:\'查看\',modid:\'marketshareUserList\',config:\'config\',columns:\'columns\',extApi:$root.common.live_domain+\'/live/marketshares/\'+item.id+\'/mobiles\'}"></span>'
                },
