        ...
        workUserList: {
            columns: [
                ...
                {name: '提交时间', field: 'created_at'},
                {
                    ...
                    fieldDirective: '<span video-task-list="item" user-work-id="item.id" title=" 查看详情" type="user" handle="false"></span> ',
                },
            ],
            config: {
                title: '答题用户列表',
                ...
                searchSupport: true,
                searchItems: [
                    {value: 'user_id', text: '用户ID', placeholder: '', default: ''},
                    {value: 'task_id', text: '任务ID', placeholder: '', default: ''},
                    {value: 'video_group_id', text: '课程ID', placeholder: '', default: ''},
                    {value: 'id', text: '作业ID', placeholder: '', default: ''},
                    {value: 'keyword', text: '关键词', placeholder: '', default: ''},
                ],
                preSelectionSearch: {},
